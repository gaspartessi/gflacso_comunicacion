...
* Rename the text_viewmore/ folder to the name of your module (eg "widget").
...
all the instances of the string "text_viewmore" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/text_viewmore/widget/g' {} \;

* Rename the file lang/en/text_viewmore.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_text_viewmore.php
...
and you should find that this text_viewmore has been added to the list of
installed modules.
