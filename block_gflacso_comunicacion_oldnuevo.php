...
class block_gflacso_comunicacion extends block_base {
    ...
    private function get_additional_class_by_value($value) {
        switch ($value) {
            case 0:
                 return "video fontawesome turquesa";
            case 1:
                 return "conferencia fontawesome magenta";
            case 2:
                 return "musica fontawesome verde";
            case 3:
                 return "audio";
            case 4:
                 return "multimedia";
            case 5:
                 return "encuesta fontawesome verde";
            case 6:
                 return "practica fontawesome magenta";
            case 7:
                 return "profesores fontawesome naranja";
            case 8:
                 return "cafe";
            case 9:
                 return "foro_verde";
